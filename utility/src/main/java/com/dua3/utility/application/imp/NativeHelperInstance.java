...
import com.dua3.utility.application.NativeHelper;
 ...
 * instead.
 */
public final class NativeHelperInstance {
     ...
     */
    public static NativeHelper get() {
        return NativeHelperUnsupported.getInstance();
    }
