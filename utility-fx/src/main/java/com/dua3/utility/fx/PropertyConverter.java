...
public class PropertyConverter {
     ...
     * @param <P> the type of Property containing the original value
     * @param property the property whose value is to be converted
     ...
     */
    public static <A, B, P extends ReadOnlyProperty<A>> ReadOnlyProperty<B> convertReadOnly(P property, Converter<A, B> converter) {
        Property<B> convertedProperty = new SimpleObjectProperty<>(converter.convert(property.getValue()));
