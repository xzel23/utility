...
public final class Dialogs {
     ...
     */
    public static AboutDialogBuilder about(@Nullable Stage parentStage) {
        return new AboutDialogBuilder(parentStage, MessageFormatter.standard());
    }
     ...
     *
     * @param parentStage the parent window for the About dialog, or null if no parent window is specified
     ...
     */
    public static AboutDialogBuilder about(@Nullable Stage parentStage, MessageFormatter messageFormatter) {
        return new AboutDialogBuilder(parentStage, messageFormatter);
    }
