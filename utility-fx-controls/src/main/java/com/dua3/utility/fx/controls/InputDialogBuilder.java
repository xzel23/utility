...
public class InputDialogBuilder extends DialogBuilder<InputDialog, InputDialogBuilder, InputResult> implements InputBuilder<InputDialogBuilder> {
    ...
    @Override
    public <T> InputDialogBuilder addInput(String id, MessageFormatter.MessageFormatterArgs label, Supplier<? extends @Nullable T> dflt, InputControl<T> control, boolean visible) {
    ...
    @Override
    public <T> InputDialogBuilder inputConstant(String id, MessageFormatter.MessageFormatterArgs label, Supplier<T> value) {
    ...
    @Override
    public <T> InputDialogBuilder inputHidden(String id, Supplier<T> value) {
    ...
    @Override
    public <T> InputDialogBuilder inputComboBox(String id, MessageFormatter.MessageFormatterArgs label, Supplier<? extends @Nullable T> dflt, Collection<T> items, Function<@Nullable T, Optional<String>> validate) {
    ...
    @Override
    public <T> InputDialogBuilder inputRadioList(String id, MessageFormatter.MessageFormatterArgs label, Supplier<? extends @Nullable T> dflt, Collection<T> items, Function<@Nullable T, Optional<String>> validate) {
