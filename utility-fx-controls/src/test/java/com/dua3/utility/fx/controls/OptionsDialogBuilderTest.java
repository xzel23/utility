...
class OptionsDialogBuilderTest extends FxTestBase {
    ...
    void testCreateBuilder() throws Exception {
        runOnFxThreadAndWait(() -> {
            // Create a builder
            OptionsDialogBuilder builder = Dialogs.options(null, MessageFormatter.standard());
    ...
    void testMethodChaining() throws Exception {
        runOnFxThreadAndWait(() -> {
            ...
            OptionsDialogBuilder builder = Dialogs.options(null, MessageFormatter.standard()).options(options).currentValues(currentValues).title("Options").header("Configure Options");
